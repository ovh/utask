...
|**`script`**    | Execute a script under `scripts` folder *Warn: This plugin will keep running until the count is done* | [Access plugin doc](./pkg/plugins/builtin/script/README.md)
